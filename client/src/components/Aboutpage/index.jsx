...
import DP from "../../images/testimonial-1.jpg";
    ...
    <Background name="aboutme">
      <AboutMePage>
        ...
        <AboutMe>
          <span>About Me</span>
          <p>
            Hi, I am Vatsal Ghoghari currently pursuing for B.Tech in CSE
            (Computer Science & Engg.) at{" "}
            <a
            ...
            <br />I also like to participate in competitive coding wars with the
            help of some public hubs like{" "}
            <a
